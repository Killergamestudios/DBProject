...
const getEmpLeaderboard = (input) => {
    ...
    return Promise.try(() => {
        const query = `
        SELECT Employee.*, COUNT(Reminder.empID , Reminder.memberID , Reminder.ISBN , Reminder.copyNr , Reminder.dateOfBorrowing , Reminder.dateOfReminder) AS NumOfReminders
        FROM Employee
